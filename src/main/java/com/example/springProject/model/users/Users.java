...
import com.example.springProject.model.email.Email;
import com.example.springProject.model.phone.Phone;
...
public class Users {
    ...
    @Column(name = "user_id")
    @GeneratedValue(strategy = GenerationType.IDENTITY)  //generate auto  incremented integer value
    private  int userId;
...
//    private Date purchaseDate;
    ...
    @OneToMany(cascade = CascadeType.ALL)
    @JoinColumn(name  = "fk_user_sensor_data" )
